/* ═══════════════════════════════════════════════
   Lumira — Tool Workbench (AI-Powered)
   ═══════════════════════════════════════════════ */
...
window.lumiraTools = (() => {
  ...
  // ── AI API Call ──
  async function callAI(toolKey, params) {
  ...
  function openTool(id) {
    ...
    if (tool.noRun) {
      ...
      runBtn.querySelector('.btn-text').textContent = 'Generate with AI ✨';
    }
  ...
  async function runCurrentTool() {
    ...
    try {
      ...
      const toast = window.lumiraAuth?.showToast || alert;
  ...
  function displayResults(results) {
    ...
    results.forEach(res => {
      ...
      // Format multi-line results with whitespace preserved
      ...
      item.querySelector('.tool-copy-btn').addEventListener('click', () => {
        ...
        const toast = window.lumiraAuth?.showToast;
  ...
  return { init, initDashboard, openTool };
})();
